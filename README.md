...
- **CSV** - summarizes age and value data of a musical instrument database
- **JSON** - counts locations of instruments in an instrument database
...
```shell
git clone https://github.com/JMTOMASSO/datafun-03-analytics
...
- [Documentation](https://jmtomasso.github.io/datafun-03-analytics/)
